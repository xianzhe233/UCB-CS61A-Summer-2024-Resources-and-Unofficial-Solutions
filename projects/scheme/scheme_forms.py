...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        # expressions.rest.first is the Pair needed to be evaluated.
...
def do_if_form(expressions, env):
    ...
    # if conditions calls are tail expressions.
...
def do_and_form(expressions, env):
    ...
    # END PROBLEM 12
    # and expression's last value eval is a tail call.
...
def do_or_form(expressions, env):
    ...
    return scheme_eval(expressions.first, env, tail = True)
    # END PROBLEM 12
    # or expression's last value eval is a tail call.
    ...
    while expressions is not nil:
        ...
        if is_scheme_true(test):
            ...
            if clause.rest is not nil:
                return eval_all(clause.rest, env) # tail recursive optimize is implemented in eval_all function
            else:
                return test
            # END PROBLEM 13
        expressions = expressions.rest
...
def make_let_frame(bindings, env):
    ...
    while bindings is not nil:
        ...
        # print("DEBUG:", bindings.first.first, bindings.first.rest)
        # the expression needed to be evaluated is bindings.first.rest.first
